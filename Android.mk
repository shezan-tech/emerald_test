...
VENDOR_PLATFORM_LINKS := \
	...
	$(TARGET_OUT_VENDOR)/lib64/libCamera_s5khm6aacmainmipiraw_Face_Capture.so \
	$(TARGET_OUT_VENDOR)/lib64/libCamera_s5khm6aacmainmipiraw_Flash_Capture.so \
	$(TARGET_OUT_VENDOR)/lib64/libCamera_s5khm6aacmainmipiraw_N3D_Capture.so \
	$(TARGET_OUT_VENDOR)/lib64/libCamera_s5khm6aacmainmipiraw_N3D_Preview.so \
	$(TARGET_OUT_VENDOR)/lib64/libCamera_s5khm6aacmainmipiraw_N3D_Video.so \
	$(TARGET_OUT_VENDOR)/lib64/libCamera_s5khm6aacmainmipiraw_P1_YUV.so \
	$(TARGET_OUT_VENDOR)/lib64/libCamera_s5khm6aacmainmipiraw_Scene_Capture.so \
	$(TARGET_OUT_VENDOR)/lib64/libCamera_s5khm6aacmainmipiraw_Scene_Preview.so \
	$(TARGET_OUT_VENDOR)/lib64/libCamera_s5khm6aacmainmipiraw_Video_1080.so \
	$(TARGET_OUT_VENDOR)/lib64/libCamera_s5khm6ofilmmainmipiraw_Face_Capture.so \
	$(TARGET_OUT_VENDOR)/lib64/libCamera_s5khm6ofilmmainmipiraw_Flash_Capture.so \
	$(TARGET_OUT_VENDOR)/lib64/libCamera_s5khm6ofilmmainmipiraw_N3D_Capture.so \
	$(TARGET_OUT_VENDOR)/lib64/libCamera_s5khm6ofilmmainmipiraw_N3D_Preview.so \
	$(TARGET_OUT_VENDOR)/lib64/libCamera_s5khm6ofilmmainmipiraw_N3D_Video.so \
	$(TARGET_OUT_VENDOR)/lib64/libCamera_s5khm6ofilmmainmipiraw_P1_YUV.so \
	$(TARGET_OUT_VENDOR)/lib64/libCamera_s5khm6ofilmmainmipiraw_Scene_Capture.so \
	$(TARGET_OUT_VENDOR)/lib64/libCamera_s5khm6ofilmmainmipiraw_Scene_Preview.so \
	$(TARGET_OUT_VENDOR)/lib64/libCamera_s5khm6ofilmmainmipiraw_Video_1080.so \
	$(TARGET_OUT_VENDOR)/lib64/libCamera_s5khm6sunnymainmipiraw_Face_Capture.so \
	$(TARGET_OUT_VENDOR)/lib64/libCamera_s5khm6sunnymainmipiraw_Flash_Capture.so \
	$(TARGET_OUT_VENDOR)/lib64/libCamera_s5khm6sunnymainmipiraw_N3D_Capture.so \
	$(TARGET_OUT_VENDOR)/lib64/libCamera_s5khm6sunnymainmipiraw_N3D_Preview.so \
	$(TARGET_OUT_VENDOR)/lib64/libCamera_s5khm6sunnymainmipiraw_N3D_Video.so \
	$(TARGET_OUT_VENDOR)/lib64/libCamera_s5khm6sunnymainmipiraw_P1_YUV.so \
	$(TARGET_OUT_VENDOR)/lib64/libCamera_s5khm6sunnymainmipiraw_Scene_Capture.so \
	$(TARGET_OUT_VENDOR)/lib64/libCamera_s5khm6sunnymainmipiraw_Scene_Preview.so \
	$(TARGET_OUT_VENDOR)/lib64/libCamera_s5khm6sunnymainmipiraw_Video_1080.so \
